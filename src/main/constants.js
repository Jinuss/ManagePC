...
export const IPC_CHANNELS = {
  ...
  // ========== 屏幕分辨率 ==========
    ...
    START_RESOLUTION_LISTEN: 'start-resolution-listen', // 开始监听分辨率变化
    STOP_RESOLUTION_LISTEN: 'stop-resolution-listen', // 停止监听分辨率变化
    RESOLUTION_CHANGED: 'resolution-changed', // 分辨率变化通知
  ...
  // ========== 系统音量 ==========
    ...
    START_VOLUME_LISTEN: 'start-volume-listen', // 开始监听音量变化
    STOP_VOLUME_LISTEN: 'stop-volume-listen', // 停止监听音量变化
    VOLUME_CHANGED: 'volume-changed', // 音量变化通知
};
